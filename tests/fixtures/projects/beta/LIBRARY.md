...
[L0005] Beta only entry | tier: candidate | added: 2026-07-08 | tags: beta | lesson: Beta-only lesson used to pad the fixture set. | evidence: Present only in beta LIBRARY. | falsifier: If this vanishes, ingest lost a record. | supersedes: —
