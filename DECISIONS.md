# distillery — DECISIONS (append-only)
...
>
> Decisions 1–20 were recorded in ROADMAP.md §"Decisions on record" between
> 2026-07-10 and 2026-08-18 and were migrated here verbatim on 2026-08-18
> during the kit 2.4.1 retrofit (kit 2.0.0 baseline requires DECISIONS.md).
> No wording was changed in the move; git history holds the original site.
